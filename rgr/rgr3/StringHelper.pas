...
BEGIN
  AvailableChars:= 'ЙЦУКЕНГШЩЗХЪФЫВАПРОЛДЖЭЯЧСМИТЬБЮЁёйцукенгшщзхъфывапролджэячсмитьбю';
...
VAR
  ...
  Position: INTEGER;
BEGIN
  SH:= 'ЙЦУКЕНГШЩЗХЪФЫВАПРОЛДЖЭЯЧСМИТЬБЮЁё';
  SL:= 'йцукенгшщзхъфывапролджэячсмитьбюее';
